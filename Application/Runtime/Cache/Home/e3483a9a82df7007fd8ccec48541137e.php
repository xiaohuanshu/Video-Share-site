...
<?php if(empty($type)): ?><a href="/share/home/movie/mlist/name?name=<?php echo ($searchname); ?>&userid=<?php echo ($searchid); ?>" class="list-group-item active">
                          全部
                        </a>
<?php else: ?>
                        <a href="/share/home/movie/mlist?name=<?php echo ($searchname); ?>&userid=<?php echo ($searchid); ?>" class="list-group-item">
                          全部
                        </a><?php endif; ?>
<?php $_result=C('videotype');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ctype): $mod = ($i % 2 );++$i; if($type != $ctype): ?><a href="/share/home/movie/mlist/type/<?php echo ($ctype); ?>?name=<?php echo ($searchname); ?>&userid=<?php echo ($searchid); ?>" class="list-group-item">
                          <?php echo ($ctype); if($ctype != '公开课'): ?>片<?php endif; ?>
                        </a>
<?php else: ?>
                        <a href="/share/home/movie/mlist/type/<?php echo ($ctype); ?>?name=<?php echo ($searchname); ?>&userid=<?php echo ($searchid); ?>" class="list-group-item active">
                          <?php echo ($ctype); if($ctype != '公开课'): ?>片<?php endif; ?>
                        </a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
<?php if($type != '其他'): ?><a href="/share/home/movie/mlist/type/其他?name=<?php echo ($searchname); ?>&userid=<?php echo ($searchid); ?>" class="list-group-item">
                          其他
                        </a>
<?php else: ?>
                        <a href="/share/home/movie/mlist/type/其他?name=<?php echo ($searchname); ?>&userid=<?php echo ($searchid); ?>" class="list-group-item active">
                          其他
                        </a><?php endif; ?>
                      </div>
                    </section>
                ...
                <section>
                  <section class="vbox">
                    <section class="scrollable padder-lg">
                      <h2 class="font-thin m-b"><?php echo ((isset($type) && ($type !== ""))?($type):'全部'); ?></h2>
...
<?php if(ismy($mvlist['id'],$uid) == '0'): ?><a href="#" onclick="ifa(<?php echo ($mvlist["id"]); ?>);" class="pull-right" data-toggle="class">
<?php else: ?>
                              <a href="#" onclick="ifa(<?php echo ($mvlist["id"]); ?>);" class="pull-right active" data-toggle="class"><?php endif; ?>
