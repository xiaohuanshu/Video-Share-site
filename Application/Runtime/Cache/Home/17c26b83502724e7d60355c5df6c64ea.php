                ...
                <section>
                  <section class="vbox">
                    <section class="scrollable padder-lg">
                      <h2 class="font-thin m-b">请愿</h2>
<div class="row m-t-lg m-b-lg">
                    <div class="col-sm-6">
                      <div class="bg-primary wrapper-md r">
                        <a href="/share/home/movie/addtitle/wish/yes">
                          <span class="h4 m-b-xs block"><i class=" icon-present i-lg"></i>发布请愿信息</span>
                          <span class="text-muted">没有找到想要的影视资源？快发布请愿看看别人有没有吧？</span>
                        </a>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="bg-black wrapper-md r">
                        <a href="/share/home/movie/addtitle">
                          <span class="h4 m-b-xs block"><i class="icon-share i-lg"></i>分享影视资源</span>
                          <span class="text-muted">如果你有本平台没有的影视资源，快来发布分享吧</span>
                        </a>
                      </div>
                    </div>
                  </div>
                      <div class="row row-sm">
<?php if(is_array($wishlist)): $k = 0; $__LIST__ = $wishlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mvlist): $mod = ($k % 2 );++$k;?><div class="col-xs-6 col-sm-2">
                          <div class="item">
                              <a href="/share/home/movie/show/id/<?php echo ($mvlist["id"]); ?>" class="h3 text-ellipsis"><?php echo ($mvlist["name"]); ?></a>
                              <a href="#" class="text-ellipsis text-xs text-muted">请愿人数:<?php echo (getwishcount($mvlist["id"])); ?></a>
                            <div class="pos-rlt">
                              <a href="/share/home/movie/show/id/<?php echo ($mvlist["id"]); ?>"><img src="<?php echo ((isset($mvlist["image"]) && ($mvlist["image"] !== ""))?($mvlist["image"]):'/share/Public/images/nopicture.jpg'); ?>.thumb.jpg" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="btn-group btn-group-justified">
<?php if(iswish($mvlist['id'],$uid) == '0'): ?><a href="#" class="btn btn-primary" data-toggle="class:" onclick="iwish(<?php echo ($mvlist["id"]); ?>);">
                                  <span class="text">请愿</span>
                                  <span class="text-active">请愿✔</span>
                                </a>
<?php else: ?>
		                <a href="#" class="btn btn-primary active" data-toggle="class:" onclick="iwish(<?php echo ($mvlist["id"]); ?>);">
                                  <span class="text">请愿</span>
                                  <span class="text-active">请愿✔</span>
                                </a><?php endif; ?>
		              <a href="/share/home/movie/edit/movieid/<?php echo ($mvlist["id"]); ?>" class="btn btn-info">编辑</a>
		              <a href="/share/home/movie/upload/movieid/<?php echo ($mvlist["id"]); ?>" class="btn btn-success">上传</a>
		            </div>
                          </div>
