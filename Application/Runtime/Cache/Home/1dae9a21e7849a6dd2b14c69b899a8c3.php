...
//pTar.width = pTar.Document.body.scrollWidth; 
                  ...
                  <div class="alert alert-warning alert-block">
                    ...
                    <p>只允许上传视频格式文件、限制大小为2GB，上传后需要等待人工审核后才会显示</p>
                    <p>如果上传的视频编码为H.264/ACC（一般为mp4格式），用户将可以在线观看视频</p>
                    <p>支持上传的视频格式：flv mkv avi rm rmvb mpeg mpg mov wmv mp4 webm</p>
                  </div>
<iframe id="ifm" src="/share/home/upload/uploadview/movieid/<?php echo ($movieid); ?>" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" onload="javascript:dyniframesize('ifm');"></iframe>
            </section>
          </section>
