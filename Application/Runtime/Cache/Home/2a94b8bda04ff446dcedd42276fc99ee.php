            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                                  <a href="#" onclick="window.location.reload();" class="pull-right text-muted m-t-lg" data-toggle="class:fa-spin"><i class="icon-refresh i-lg  inline" id="refresh"></i></a>
                <h2 class="font-thin m-b">公告</h2>
                  <div class="col-lg-6" style="width:100%">
                  <!-- .crousel slide -->
                  <section class="panel panel-default">
                    <div class="carousel slide auto panel-body" id="c-slide">
                        <ol class="carousel-indicators out">
<?php if(is_array($noticelist)): $nk = 0; $__LIST__ = $noticelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notice): $mod = ($nk % 2 );++$nk; if($nk-1 == 0): ?><li data-target="#c-slide" data-slide-to="<?php echo ($nk-1); ?>" class="active"></li>
<?php else: ?>
                          <li data-target="#c-slide" data-slide-to="<?php echo ($nk-1); ?>" class=""></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        </ol>
                        <div class="carousel-inner">
<?php if(is_array($noticelist)): $nk = 0; $__LIST__ = $noticelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notice): $mod = ($nk % 2 );++$nk; if($nk-1 == 0): ?><div class="item active">
                            <p class="text-center">
                              <em class="h4 text-mute"><?php echo ($notice["title"]); ?></em><br>
                              <small class="text-muted"><?php echo ($notice["content"]); ?></small>
                            </p>
                          </div>
<?php else: ?>
                          <div class="item">
                ...
                <div class="col-lg-12">
                  ...
                  <h2 class="font-thin m-b">最新影视动态<span class="musicbar animate inline m-l-sm" style="width:20px;height:20px">
...
<?php if(is_array($movielist)): $k = 0; $__LIST__ = $movielist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mvlist): $mod = ($k % 2 );++$k;?><div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
<?php if((isMy($mvlist['id'],$uid) == '1')): ?><div class="top">
                            <span class="pull-right m-t-n-xs m-r-sm text-white">
                              <i class="fa fa-bookmark i-lg"></i>
                            </span>
                          </div><?php endif; ?>
<?php if(!empty($$mvlist['time'])): ?><div class="bottom">
                            <span class="badge bg-info m-l-sm m-b-sm"><?php echo ($mvlist["time"]); ?></span>
                          </div><?php endif; ?>
                          <div class="item-overlay opacity r r-2x bg-black">
                            <div class="center text-center m-t-n">
                              <a href="/share/home/movie/show?id=<?php echo ($mvlist["id"]); ?>"><i class="icon-control-play i-2x"></i></a>
                            </div>
                            <div class="bottom padder m-b-sm">
<?php if((ismy($mvlist['id'],$uid) == '0')): ?><a href="#" class="pull-right" data-toggle="class" onclick="ifa($mvlist.id);">
<?php else: ?>
                              <a href="#" class="pull-right active" data-toggle="class" onclick="ifa($mvlist.id);"><?php endif; ?>
                                <i class="fa fa-star-o text"></i>
                                <i class="fa fa-star text-active text-danger"></i>
                              </a>
                            </div>
                          </div>
                          <a href="#"><img src="<?php echo ((isset($mvlist["image"]) && ($mvlist["image"] !== ""))?($mvlist["image"]):'/share/Public/images/nopicture.jpg'); ?>.thumb.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                          <a href="/share/home/movie/show?id=<?php echo ($mvlist["id"]); ?>" class="text-ellipsis"><?php echo ($mvlist["name"]); ?></a>
<?php $_result=explode(',',$mvlist['type']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mtype): $mod = ($i % 2 );++$i;?><a href="/share/home/movie/mlist?type=<?php echo ($mtype); ?>" class="text-xs text-muted"><?php echo ($mtype); ?> </a><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                      </div>
                    </div>
<?php if((($k)%2==0 and $k!=12)): ?><div class="clearfix visible-xs"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                  </div>
                  <div class="row">
                    <div class="col-md-7">
                      <h3 class="font-thin">请愿资源</h3>
                      <div class="row row-sm">
<?php if(is_array($wishlist)): $i = 0; $__LIST__ = $wishlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wslist): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              <a href="/share/home/movie/show?id=<?php echo ($wslist["id"]); ?>"><img src="<?php echo ((isset($wslist["image"]) && ($wslist["image"] !== ""))?($wslist["image"]):'/share/Public/images/nopicture.jpg'); ?>.thumb.jpg" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                              <a href="/share/home/movie/show?id=<?php echo ($wslist["id"]); ?>" class="text-ellipsis"><?php echo ($wslist["name"]); ?></a>
                              <a href="#" class="text-ellipsis text-xs text-muted">请愿人数:<?php echo (getwishcount($wslist["id"])); ?></a>
                            </div>
                          </div>
                    ...
                    <div class="col-md-5">
                      <h3 class="font-thin">分享资源榜</h3>
                      <div class="list-group bg-white list-group-lg no-bg auto">       
<?php if(is_array($sharelist)): $sk = 0; $__LIST__ = $sharelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$srlist): $mod = ($sk % 2 );++$sk;?><a href="/share/home/user/profile/uid/<?php echo ($srlist["userid"]); ?>" class="list-group-item clearfix">
                          <span class="pull-right h2 text-muted m-l"><?php echo ($sk); ?></span>
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="/ucenter/avatar.php?uid=<?php echo ($uid); ?>&type=virtual&size=middle" alt="...">
                          </span>
                          <span class="clear">
                            <span><?php echo (getusernamebyid($srlist["userid"])); ?></span>
                            <small class="text-muted clear text-ellipsis">分享数量:<?php echo ($srlist["c"]); ?></small>
                          </span>
                        </a><?php endforeach; endif; else: echo "" ;endif; ?>
                      </div>
                    </div>
...
<?php if($islogin == 0): ?><div class="col-sm-6">
                      <div class="bg-primary wrapper-md r">
                        <a href="#modal-login" data-toggle="modal">
                          <span class="h4 m-b-xs block"><i class=" icon-user-follow i-lg"></i> 登录或者注册一个帐号</span>
...
<?php if($islogin == 0): ?><div class="col-sm-6">
<?php else: ?>
                    <div class="col-sm-12" ><?php endif; ?>
                      <div class="bg-black wrapper-md r">
                        <a href="#">
                          <span class="h4 m-b-xs block"><i class="fa fa-dollar i-lg"></i> 给我们捐赠</span>
                          <span class="text-muted">为了保证此平台的长期运作，经济允许的同学请捐赠我们一些经费来激励我们</span>
                        </a>
                      </div>
                    </div>
                  </div>
...
<?php if($issearch == 0): ?>最新用户
<?php else: ?>
搜索结果<?php endif; ?>
                  </h4>
                  <ul class="list-group no-bg no-borders auto m-t-n-xxs">
<?php if(is_array($newuserlist)): $i = 0; $__LIST__ = $newuserlist;if( count($__LIST__)==0 ) : echo "没有查询到结果..." ;else: foreach($__LIST__ as $key=>$nul): $mod = ($i % 2 );++$i;?><li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="/ucenter/avatar.php?uid=<?php echo ($nul["userid"]); ?>&type=virtual&size=middle" alt="..." class="img-circle">
                      </span>
                      <div class="clear">
                        <div><a href="/share/home/user/profile/uid/<?php echo ($nul["userid"]); ?>"><?php echo ($nul["username"]); ?></a></div>
                        <small class="text-muted"><?php echo ($nul["realname"]); ?></small>
                      </div>
                    </li><?php endforeach; endif; else: echo "没有查询到结果..." ;endif; ?>
                  </ul>
                </section>
                  ...
                  <form class="" role="search" method="get">
                    <div class="form-group clearfix m-b-none">
                      <div class="input-group m-t m-b">
                        ...
                        <input name="searchuser" type="text" class="form-control input-sm text-white bg-empty b-b b-dark no-border" placeholder="搜索用户...">
                      </div>
                    </div>
                  </form>
                </footer>
